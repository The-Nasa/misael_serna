...
export const regidores: Regidor[] = [
  {
    ...
    cargo: "Regidor 1",
    foto: "/images/regidores/01_HERLIN_GRANDEZ_PANDURA.webp",
    numero: "1",
    descripcion: [],
  ...
  },
  {
    ...
    cargo: "Regidora 2",
    foto: "/images/regidores/02_PATY_RAMOS_YUCRA.webp",
    numero: "2",
    descripcion: [],
  ...
  },
  {
    ...
    cargo: "Regidor 3",
    foto: "/images/regidores/03_ABUDENIO_DURAND_LAZARO.webp",
    numero: "3",
    descripcion: [],
  ...
  },
  {
    ...
    cargo: "Regidora 4",
    foto: "/images/regidores/04_MARÍA_SAAVEDRA_DE_CATPO.webp",
    numero: "4",
    descripcion: [],
  ...
  },
  {
    ...
    cargo: "Regidor 5",
    foto: "/images/regidores/05_FRANCHESCOLY_RIMACHI_LEGUIA.webp",
    numero: "5",
    descripcion: [],
  ...
  },
  {
    ...
    cargo: "Regidora 6",
    foto: "/images/regidores/06_JESSENIA_ROBLEDO_MERINO.webp",
    numero: "6",
    descripcion: [],
